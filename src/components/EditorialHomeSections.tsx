  ...
  return (
    <section className="editorial-color section" id="color" aria-labelledby="editorial-color-title">
      <div className="container">
        <div className="editorial-color__heading">
        ...
        <div className="editorial-color__diagnosis">
          ...
          <div className="editorial-color__copy">
            ...
            <ul>
              {diagnosticPoints.map((point) => <li key={point}>{point}</li>)}
            </ul>
        ...
        {galleryStyles.length > 0 && (
          <div className="editorial-color__gallery" aria-label="Coloraciones publicadas">
  ...
  return (
    <section className="editorial-process section" id="experiencia" aria-labelledby="editorial-process-title">
      <div className="container">
        ...
        <ol className="editorial-process__list">
  ...
  return (
    <section className="editorial-transformations section" id="transformaciones" aria-labelledby="editorial-transformations-title">
      <div className="container">
        ...
        <div className={`editorial-transformations__grid ${comparison ? '' : 'editorial-transformations__grid--gallery-only'}`}>
          {comparison && (
  ...
  return (
    <section className="editorial-events section" id="eventos" aria-labelledby="editorial-events-title">
      <div className="container editorial-events__grid">
        <div className="editorial-events__content">
        ...
        <div className="editorial-events__gallery">
  ...
  return (
    <section className="editorial-treatments section" id="tratamientos" aria-labelledby="editorial-treatments-title">
      <div className="container editorial-treatments__grid">
        <div className="editorial-treatments__content">
        ...
        {visual && (
          <a className="editorial-treatments__visual" href={`/estilos/${encodeURIComponent(visual.slug)}`} aria-label={`Ver ${visual.name}`}>
...
export function EditorialClosingImage() {
  ...
  return (
    <section className="editorial-closing-image" aria-label="Imagen editorial de Marilyn Coiffure">
      <PositionedImage
